      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: "vendor-return",
            component: () =>
              import("@/admin-panel/nazad/vendorReturn/VendorReturnLayout.vue"),
            children: [
              {
                ...
                component: () =>
                  import(
                    "@/admin-panel/nazad/vendorReturn/VendorReturnList.vue"
                  ),
              },
              {
                ...
                component: () =>
                  import(
                    "@/admin-panel/nazad/vendorReturn/VendorReturnAdd.vue"
                  ),
              },
              {
                path: "vendor-return-edit/:id",
                name: "vendor-return-edit",
                component: () =>
                  import(
                    "@/admin-panel/nazad/vendorReturn/VendorReturnEdit.vue"
                  ),
              },
            ],
          },
          ...
          },
          {
            ...
            name: "inventory",
            component: () =>
              import("@/admin-panel/foysal/components/inventory/Inventory.vue"),
            children: [
              {
                path: "inventoryadd",
                name: "inventoryadd",
                component: () =>
                  import(
                    "@/admin-panel/foysal/components/inventory/Inventoryadd.vue"
                  ),
              },
              {
                path: "inventorylist",
                ...
                component: () =>
                  import(
                    "@/admin-panel/foysal/components/inventory/Inventorylist.vue"
                  ),
              },
              {
                ...
                component: () =>
                  import(
                    "@/admin-panel/foysal/components/inventory/Inventoryupdate.vue"
                  ),
              },
            ],
          },
          ...
          },
          {
            ...
            component: () =>
              import(
                "@/admin-panel/fazle/customer-report/components/CustomerLayout.vue"
              ),
            children: [
              {
                path: "customer-list",
                ...
                component: () =>
                  import(
                    "@/admin-panel/fazle/customer-report/views/CustomerList.vue"
                  ),
              },
              {
                path: "creport/:id",
                ...
                component: () =>
                  import(
                    "@/admin-panel/fazle/customer-report/views/CustomerReport.vue"
                  ),
              },
              {
                path: "coreport/:id",
                ...
                component: () =>
                  import(
                    "@/admin-panel/fazle/customer-report/views/CustomerOrderReport.vue"
                  ),
              },
            ],
          },
